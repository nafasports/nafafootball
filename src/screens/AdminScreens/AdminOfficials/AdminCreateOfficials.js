...
const AdminCreateOfficials = () => {
  const navigate = useNavigate();
  const [name, setName] = useState("");
  const [team, setTeam] = useState("");
  const [license, setLicense] = useState("");
  const [officiatingRole, setOfficiatingRole] = useState("");
  ...
  const submitHandler = (e) => {
    ...
    const data = {
      ...
      name: name,
      team: team,
      officiatingRole: officiatingRole,
    ...
    axios
      .post("https://nafasports.herokuapp.com/api/officials", data, headers)
                ...
                <div class="row mt-3">
                  ...
                  <div class="col-md-12">
                    ...
                    <input
                      type="text"
                      class="form-control"
                      placeholder="officiating role"
                      value={officiatingRole}
                      onChange={(e) => setOfficiatingRole(e.target.value)}
                    />
                  </div>
                </div>
                <div class="row mt-3">
...
export default AdminCreateOfficials;
